    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.CharField(choices=[('Johor', 'Johor'), ('Kuala Lumpur', 'Kuala Lumpur'), ('Penang', 'Penang')], default=None, max_length=55, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deletion_time', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('delete_user_id', models.CharField(max_length=50)),
                ('company_id', models.ForeignKey(default=True, on_delete=django.db.models.deletion.CASCADE, to='objects.Company', verbose_name='Company')),
            ],
            options={
