# Generated by Django 3.0.3 on 2020-03-24 10:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deletion_time', models.DateTimeField(blank=True, null=True)),
                ('delete_user_id', models.CharField(blank=True, max_length=50)),
                ('form_type_template_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inspection.FormTypeTemplate')),
            ],
            options={
