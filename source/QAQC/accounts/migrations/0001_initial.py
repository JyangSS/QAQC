    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_documentcontroller', models.BooleanField(blank=True, default=False, null=True)),
                ...
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='generals.Company')),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='generals.Department')),
