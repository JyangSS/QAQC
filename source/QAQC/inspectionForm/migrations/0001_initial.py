# Generated by Django 3.0.3 on 2020-03-11 17:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('deletion_time', models.DateTimeField(blank=True, default=datetime.datetime.now)),
                ('delete_user_id', models.CharField(max_length=50)),
                ('phase_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='inspectionForm.Phase', verbose_name='Phase')),
            ],
            options={
